...
9. 같은 통계 탭의 `내 풀이 성장`에서 이번 달 풀이량, 플랫폼별 난이도 분포, 주간 난이도 추세와 최근 3개월 도전 수준을 확인합니다.
...
## 풀이 성장 통계
개인 풀이 성장 통계는 인증 여부와 별개로 `hamster_submissions`의 실제 풀이 기록을 집계합니다.
...
- 미인증 reminder: 23:30 KST 이후 현재 Study Day가 아직 완료되지 않았고 미루기도 신청하지 않은 사용자에게 `🐹 아직 오늘 인증이 안 됐어. 04:00 전까지 풀거나 미루기 신청해줘! 쮸!`를 전송합니다.
...
- 완료 또는 미루기 상태에는 reminder를 보내지 않습니다.
...
- 모바일 주간/월간 전환
- 멤버별 월간 통계
- 개인 월별 풀이량 / 난이도 분포 / 주간 추세 / 최근 3개월 도전 수준 통계
